# Team-9 Deep Learning: Kaggle Binary Image Classification Challenge
...
This repository contains the complete deep learning codebase, modular package architecture, automated data acquisition tools, and experimentation findings developed by **Team-9** for the [**IITH Deep Learning 2026 Hackathon**](https://www.kaggle.com/competitions/iith-deep-learning-2026-hackathon) hosted on Kaggle.
...
| :--- | :--- | :--- |
| **Rajat Maheswari** | CS25MTECH02007 | Dual CNN design, training & loss formulation (Best Model); Slot Attention implementation; VAE + CNN exploration |
| **Raja Sudha Sri Harika** | CS25MTECH02001 | Vision Transformer (ViT) implementation; ClevrTex dataset exploration & integration; Hyperparameter tuning |
| **Deeba Afridi** | CS24MTECH12018 | Colour space analysis (RGB vs HSV vs LAB); Exploratory Data Analysis (EDA) & annotation; Object masking pipeline |
...
│   └── Team-9-DL-project.pdf          # Academic project report
...
├── Team-9-DualCNN.py                  # Backward-compatible facade
...
### Option 2: Backward-Compatible Legacy Script (`Team-9-DualCNN.py`)
```bash
...
1. **CLEVR**: Johnson, J., Hariharan, B., van der Maaten, L., et al. (2017). *CLEVR: A Diagnostic Dataset for Compositional Language and Elementary Visual Reasoning*. CVPR 2017. [arXiv:1612.06890](https://arxiv.org/abs/1612.06890)
2. **ClevrTex**: Karazija, L., Laina, I., & Rupprecht, C. (2021). *ClevrTex: A Texture-Rich Benchmark for Unsupervised Multi-Object Segmentation*. NeurIPS 2021 Datasets and Benchmarks Track. [ClevrTex Project](https://www.robots.ox.ac.uk/~vgg/research/clevrtex/)
3. **Slot Attention**: Locatello, F., Weissenborn, D., Unterthiner, T., et al. (2020). *Object-Centric Learning with Slot Attention*. NeurIPS 2020. [arXiv:2006.15055](https://arxiv.org/abs/2006.15055)
4. **CoordConv**: Liu, R., Lehman, J., Petroski Such, F., et al. (2018). *An Intriguing Failing of Convolutional Neural Networks and the CoordConv Solution*. NeurIPS 2018. [arXiv:1807.03247](https://arxiv.org/abs/1807.03247)
5. **Vision Transformer (ViT)**: Dosovitskiy, A., Beyer, L., Kolesnikov, A., et al. (2021). *An Image is Worth 16x16 Words: Transformers for Image Recognition at Scale*. ICLR 2021. [arXiv:2010.11929](https://arxiv.org/abs/2010.11929)
